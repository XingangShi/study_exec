...
>
> ![进入 Vim 世界的钥匙](./images/RkyFnKB.png "进入 Vim 世界的钥匙")
...
>
> ![编辑器学习曲线比较](./images/nPseEdr.png "编辑器学习曲线比较")
>
...
>
> ![一个 vim 的配置示例](./images/RimWsEH.png "一个 vim 的配置示例")
>
...
> ![openvim](./images/uGopYlD.png "openvim")

##### 4.2 [vim adventures](https://vim-adventures.com/)
> ![vim adventures](./images/mJefISJ.png "vim adventures")
...
> ![VIMTUTOR](./images/w4wanpd.png "VIMTUTOR")
...
>> ![VIM Cheat Sheet for Programmers](./images/MeR6AjS.jpg "VIM Cheat Sheet for Programmers")
...
>> ![Beautiful VIM Cheat Sheet](./images/Vt1hVGy.jpg "Beautiful VIM Cheat Sheet")

##### 5.3 [Vi / Vim Graphical Cheat Sheet](http://www.viemu.com/a_vi_vim_graphical_cheat_sheet_tutorial.html)
>> ![Vi \ Vim Graphical Cheat Sheet](./images/1pwYVSP.jpg "Vi \ Vim Graphical Cheat Sheet")

##### 5.4 [Vi Cheat Sheet](https://www.gosquared.com/blog/vi-linux-terminal-help-sheet)
>> ![Vi Cheat Sheet](./images/TBfub5z.jpg "Vi Cheat Sheet")

##### 5.5  [VIM Cheat Sheet for Programmers](https://vim.rtorr.com/lang/zh_cn/)
>> ![VIM Cheat Sheet for Programmers](./images/ol5vQNv.jpg "VIM Cheat Sheet for Programmers")
...
>
> ![SpaceVim 样例](./images/6Q8Ewu7.png "SpaceVim 样例")

##### 6.2 [Neovim  : literally the future of vim](https://neovim.io/)
> ![Neovim 样例](./images/8Q3PSvU.png "Neovim 样例")

##### 6.3 [exVim : 将Vim变成一个很好的编程环境的项目](https://exvim.github.io/)
> ![exVim 样例](./images/1dOV21d.png "exVim 样例")

##### 6.4 [PowerVim : 让你的 vim 更强大，更轻松]
> ![PowerVim 样例](./images/IOGKHIc.png "PowerVim 样例")
